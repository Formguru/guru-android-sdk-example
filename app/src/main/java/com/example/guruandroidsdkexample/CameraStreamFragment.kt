...
class CameraStreamFragment @SuppressLint("ValidFragment") private constructor(
    private val cameraId: String,
    private val cameraConnectionCallback: ConnectionCallback?,
    /** A [InferenceAvailableListener] to receive frames and their corresponding inference result as they are available.  */
    private val cameraListener: ImageReader.OnImageAvailableListener,
    ...
    companion object {
        ...
        fun newInstance(
            cameraId: String,
            cameraListener: ImageReader.OnImageAvailableListener,
            layout: Int,
            inputSize: Size
        ): CameraStreamFragment {
            return CameraStreamFragment(cameraId, null, cameraListener, layout, inputSize)
        }
    ...
    private val LOG_TAG = "CameraConnectionFragment"
    ...
    private fun createCameraPreviewSession() {
        try {
            ...
            previewReader!!.setOnImageAvailableListener(cameraListener, backgroundHandler)
    ...
    private fun configureTransform(viewWidth: Int, viewHeight: Int) {
        ...
        // Emulators apply a rotation to the webcam, so respond accordingly
        if (arrayListOf("sdk_gphone_x86", "sdk_gphone64_x86_64").contains(Build.MODEL)) {
